...
public class FacturaViewImpl extends javax.swing.JPanel implements FacturaView {
    ...
    private void jButtonFiltrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonFiltrarActionPerformed
        ...
        List<Factura> facturas=((FacturaModel)getModel()).listarPorClientes(cliente.getDNI());
    ...
    public void refresh() {
        facturaTableModel.setFacturas(getModel().obtenerFacturas());//cambia el modelo de JTable(TableModel) por medio de una clase que hemos creado (ContactosTableModel)
    }

    protected void fireNuevaFacturaGesture(String identificador, Cliente cliente, double importe) {
        this.getController().nuevaFacturaGesture(identificador, cliente, importe);
    }

    protected void fireActualizaFacturaGesture(String identificador, Cliente cliente, double importe) {
    ...
    protected void fireBorraFacturaGesture(String identificador) {
        this.getController().eliminarFacturaGesture(identificador);
    }
